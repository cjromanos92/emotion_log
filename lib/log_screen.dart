...
class _LogScreenState extends State<LogScreen> {
      ...
      finalPanels.add(NewItem(
          ...
          Padding(
              ...
              child: Wrap(
                  spacing: 8,
                  runSpacing: 10,
                  children: buildEmojiList(category)
              )) // iconPic
      ),);
    }
    return ListView(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 60,
                    width: 60,
                    child: Image.asset(
                      'assets/images/${face.path}', fit: BoxFit.scaleDown,)),
                SizedBox(height: 4,),
                SizedBox(child: Text(face.name,
  ...
  List<String> getCategoryList() {
    ...
    for (var face in emojis) {
      if (categoryList.contains(face.category)) {} else {
